...
\begin{tabular}{lll}
\toprule
\includegraphics[width=0.3\textwidth]{temp_maps/01.Centro_ABC.png} & \includegraphics[width=0.3\textwidth]{temp_maps/01.Centro_ABC3.png} & \includegraphics[width=0.3\textwidth]{temp_maps/02.Centro_SDF.png}\\
\bottomrule
\end{tabular}
\end{table}
